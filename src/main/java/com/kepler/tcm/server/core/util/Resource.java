...
public class Resource extends BaseResource {
	...
	public static Resource getResource(String fileName, String charsetName) throws Exception {
		return (Resource) getResource(Resource.class.getName(), fileName, charsetName);
	}
	...
	protected void handleResrouce(InputStreamReader r) throws Exception {
		...
		while ((line = br.readLine()) != null) {
			...
			if ((b) && (line.length() > 0) && (line.charAt(0) == 65279) && (this.charset != null)
					&& (this.charset.equals("UTF-8"))) {
