...
public abstract class BaseResource {
	...
	private static synchronized BaseResource getResourceSync(String className, String fileName, String charsetName)
			throws Exception {
	...
	protected static BaseResource getResource(String className, String fileName, String charsetName) throws Exception {
		if (resourceMap == null)
	...
	protected abstract void handleResrouce(InputStreamReader paramInputStreamReader) throws Exception;

	protected void loadResource(String fileName, String charsetName) throws Exception {
		InputStream is = null;
		...
		if (is == null) {
			System.out.println("Resource " + fileName + " is not exists. Try to create it.");
			File f = new File(fileName);
			f.getParentFile().mkdirs();
			if (f.createNewFile()) {
				System.out.println("Resource file " + f.getCanonicalPath() + " created");
				this.realFileName = fileName;
				is = new FileInputStream(fileName);
			}
