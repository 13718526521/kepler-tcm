...
public class FileTools {
	...
	public static void appendFileText(String _sFileName, String _sAddContent)
			throws IOException {
	...
	public static void setFileText(String _sFileName, String _sAddContent)
			throws IOException {
		RandomAccessFile raf = new RandomAccessFile(_sFileName, "rw");
	...
	public static void setFileText(File _sFileName, String _sAddContent,
			String charset) throws IOException {
	...
	public static String getFileText(String fileName, String charsetName)
			throws IOException {
		return getFileText(new File(fileName), charsetName);
	}

	public static String getFileText(File f, String charsetName)
			throws IOException {
		if (!f.exists())
			return "";
