...
public class PluginController {
	...
	public Map<String, Object> upload(String agentAndServer,Plugin plugin, MultipartFile[] file)
			throws Exception {
		return pluginService.upload(agentAndServer,plugin, file);
	}
	@RequestMapping(value = "/uploadedit", method = RequestMethod.POST)
	public Map<String, Object> uploadedit(String agentAndServer,Plugin plugin, MultipartFile[] file)
			throws Exception {
		return pluginService.uploadedit(agentAndServer,plugin, file);
	}

	public static boolean uploadIStream(String rootPath, String fileName,
