...
public class BaseCacheTest extends AbstractTransactionalJUnit4SpringContextTests {
	
	protected static Logger logger = LoggerFactory.getLogger(BaseCacheTest.class);
